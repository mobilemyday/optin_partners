            ...
            <form method="post" action="/run.php">
                <section>
                    ...
                    <fieldset class="inputstyle hidden">
                        <label for="software">Welke?</label>
                    ...
                    <fieldset>
                        <button name="submit" class="btn" type="submit">BEVESTIGEN</button>
                    </fieldset>  
                </section>
                <input type="hidden" name="form[language]" value="nl">
            </form>
        </div>
    </body>
